...
#define GENERATORE_FALLIMENTI_SIGSTOP "SIGSTOP signal sent"
#define GENERATORE_FALLIMENTI_SIGINT  "SIGINT signal sent"
#define GENERATORE_FALLIMENTI_SIGCONT "SIGCONT signal sent"
#define GENERATORE_FALLIMENTI_SIGUSR1 "SIGUSR1 signal sent"
